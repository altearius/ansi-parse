...
const config = [
	...
	},
	{
		...
		files: ['**/*.test.ts'],
		rules: {
			// Justification: The Node test runner defines `describe`, `it`, and
			// related functions as returning promises (that resolve immediately).
			// I have to decide whether to disable the lint rule or to litter the
			// test code with needless `await` or `void` statements.
			'@typescript-eslint/no-floating-promises': 'off',

			// Justification: We can afford to be a bit more lax in test code.
			...
			// Justification: Tests can run on a bit.
